...
func _physics_process(delta):
	...
	#Game Logic ======================================================	
	if $"/root/Global".allCoins.size() == 0 && $"/root/Global".finalScore <= 2:
		$"/root/Global".dialogCanRun = false
		$"/root/Global".finalScore = 0
		get_tree().change_scene("res://youLose.tscn")
	
	if $"/root/Global".allCoins.size() == 0 && $"/root/Global".finalScore == 3:
		get_tree().change_scene("res://Stage3Intro.tscn")
	#============================================================================
